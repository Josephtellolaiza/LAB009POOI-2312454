...
public class Estudiantes2023 {
    ...
    public void verEstudiantesPorApellidos() {
        if (estudiantes.isEmpty()) {
            ...
            Collections.sort(estudiantes, Comparator.comparing(Estudiante::getApellidos));

            System.out.println("Lista de Estudiantes ordenados por apellidos:");
            for (Estudiante estudiante : estudiantes) {
                System.out.println("Nombre: " + estudiante.getNombre());
                System.out.println("Apellidos: " + estudiante.getApellidos());
                System.out.println("Ciclo: " + estudiante.getCiclo());
                System.out.println("Pensión: " + estudiante.getPension());
                System.out.println("-----------------------");
            }
        }
    }
